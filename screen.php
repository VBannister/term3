		...
		<div id="page-wrapper">
						...
						<ul>
							...
							<li>
								...
								<ul>
									...
									<li><a href="screen.html">P3 Uploader</a></li>
									<li><a href="screen.html">Elements</a></li>
									<li>
										<a href="#">Submenu</a>
										<ul>
			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						<h2>Browser Dectection.</h2>
						<p>This page will detect your browser and your screen resolution.</p>
					</header>
					<div class="box">
